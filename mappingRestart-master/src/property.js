...
class Property {
    ...
    TYPES = {
        // 本局
        AGE: "AGE", // 年龄 age AGE
        CHR: "CHR", // 建图速度 charm CHR
        INT: "INT", // 建图精度 intelligence INT
        STR: "STR", // 建图完整度 strength STR
        MNY: "MNY", // 建图稠密度 money MNY
        SPR: "SPR", // 建图小熊度 spirit SPR
        LIF: "LIF", // 生命 life LIFE
        TLT: "TLT", // 方法 talent TLT
        ...
        LCHR: "LCHR", // 最低建图速度 Low Charm
        HCHR: "HCHR", // 最高建图速度 High Charm
        LINT: "LINT", // 最低建图精度 Low Intelligence
        HINT: "HINT", // 最高建图精度 High Intelligence
        LSTR: "LSTR", // 最低建图完整度 Low Strength
        HSTR: "HSTR", // 最高建图完整度 High Strength
        LMNY: "LMNY", // 最低建图稠密度 Low Money
        HMNY: "HMNY", // 最高建图稠密度 High Money
        LSPR: "LSPR", // 最低建图小熊度 Low Spirit
        HSPR: "HSPR", // 最高建图小熊度 High Spirit
